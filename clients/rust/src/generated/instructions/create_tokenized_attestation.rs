...
pub struct CreateTokenizedAttestation {
    ...
    pub recipient_token_account: trezoa_program::pubkey::Pubkey,
    /// Wallet to receive Attestation Token
    pub recipient: trezoa_program::pubkey::Pubkey,
...
pub struct CreateTokenizedAttestationBuilder {
    ...
    schema: Option<trezoa_program::pubkey::Pubkey>,
    attestation: Option<trezoa_program::pubkey::Pubkey>,
    system_program: Option<trezoa_program::pubkey::Pubkey>,
    schema_mint: Option<trezoa_program::pubkey::Pubkey>,
    attestation_mint: Option<trezoa_program::pubkey::Pubkey>,
    sas_pda: Option<trezoa_program::pubkey::Pubkey>,
    recipient_token_account: Option<trezoa_program::pubkey::Pubkey>,
    recipient: Option<trezoa_program::pubkey::Pubkey>,
...
impl CreateTokenizedAttestationBuilder {
    ...
    /// Schema the Attestation is associated with
    #[inline(always)]
    pub fn schema(&mut self, schema: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// Mint of Schema Token
    #[inline(always)]
    pub fn schema_mint(&mut self, schema_mint: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn recipient_token_account(
        &mut self,
        recipient_token_account: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    /// Wallet to receive Attestation Token
    #[inline(always)]
    pub fn recipient(&mut self, recipient: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = CreateTokenizedAttestation {
            ...
            associated_token_program: self.associated_token_program.unwrap_or(
                trezoa_program::pubkey!("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"),
            ),
        };
...
pub struct CreateTokenizedAttestationCpiAccounts<'a, 'b> {
    ...
    /// Schema the Attestation is associated with
    pub schema: &'b trezoa_program::account_info::AccountInfo<'a>,
    ...
    /// Mint of Schema Token
    pub schema_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint of Attestation Token
    pub attestation_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Program derived address used as program signer authority
    pub sas_pda: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Associated token account of Recipient for Attestation Token
    pub recipient_token_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Wallet to receive Attestation Token
    pub recipient: &'b trezoa_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> CreateTokenizedAttestationCpiBuilder<'a, 'b> {
    ...
    pub fn schema(
        &mut self,
        schema: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn schema_mint(
        &mut self,
        schema_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn recipient_token_account(
        &mut self,
        recipient_token_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn recipient(
        &mut self,
        recipient: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct CreateTokenizedAttestationCpiBuilderInstruction<'a, 'b> {
    ...
    schema: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ...
    schema_mint: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ...
    recipient_token_account: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    recipient: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
