...
pub struct ChangeSchemaVersion {
    ...
    pub existing_schema: trezoa_program::pubkey::Pubkey,

    pub new_schema: trezoa_program::pubkey::Pubkey,
...
pub struct ChangeSchemaVersionBuilder {
    ...
    existing_schema: Option<trezoa_program::pubkey::Pubkey>,
    new_schema: Option<trezoa_program::pubkey::Pubkey>,
...
impl ChangeSchemaVersionBuilder {
    ...
    pub fn existing_schema(
        &mut self,
        existing_schema: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.existing_schema = Some(existing_schema);
        self
    }
    #[inline(always)]
    pub fn new_schema(&mut self, new_schema: trezoa_program::pubkey::Pubkey) -> &mut Self {
...
pub struct ChangeSchemaVersionCpiAccounts<'a, 'b> {
    ...
    pub existing_schema: &'b trezoa_program::account_info::AccountInfo<'a>,

    pub new_schema: &'b trezoa_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> ChangeSchemaVersionCpiBuilder<'a, 'b> {
    ...
    pub fn existing_schema(
        &mut self,
        existing_schema: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_schema(
        &mut self,
        new_schema: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ChangeSchemaVersionCpiBuilderInstruction<'a, 'b> {
    ...
    existing_schema: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_schema: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
